...
struct Params
{
  ...
  std::vector<double> world_dimensions = { 120.0, 120.0, 4.0 };
  ...
  int skip = 0;
  double depth_max = 3;
  double depth_max_z = 3.0; //for 3D lidar added by Mahathi
  double depth_max_x = 70.0; // velodyne puck
  double depth_max_y = 70.0; // velodyne puck
  double r1 = 0.8;
  double r2 = 8.0;
