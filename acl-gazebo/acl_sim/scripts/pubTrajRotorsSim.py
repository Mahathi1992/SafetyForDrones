...
import rospy
import math
import trajectory_msgs.msg as trajmsg
...
pubGoal = rospy.Publisher(name+'command/trajectory', trajmsg.JointTrajectory, queue_size=10)
...
def startNode():
    ...
    desState = trajmsg.JointTrajectory()
